...
int main( int argc, char ** argv)
{
  ...
  MyLabel *label_mostra   = new MyLabel ( "Etiqueta de mostra", w); //lbl1
  ...
  app.connect(txtLine, SIGNAL(textChanged(const QString&)), label_mostra, SLOT(setUppercaseText(const QString &)));
