...
void setCamera () {
	...
	glLoadIdentity();
	if (ORTHO_CAMERA) glOrtho(-WME*vw, WME*vw, -WME*quo, WME*quo, -WME*quo+dist, WME*quo+dist);
	else gluPerspective(2*atan(WME*quo/(dist-WME*quo))*(180/M_PI), viewportRatio, dist-WME*quo, dist+WME*quo);
